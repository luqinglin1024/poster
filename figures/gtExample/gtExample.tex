...
\node[anchor=south west,inner sep=0] (imgNode) at (0,0) {\includegraphics[width=4cm]{pngImgs/gt/000002.png}};

\node[anchor=south east,inner sep=0] at (-8pt,0) {\includegraphics[width=4cm]{pngImgs/000002.png}};
